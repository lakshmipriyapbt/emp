...
//       setOtpExpired(true);  // OTP expired
//       setOtpShown(false);  // Hide OTP input
//       if (step !== 3) {  // Avoid resetting to Step 1 if Step 3 is active
//         setStep(1); // Go to Step 1 (Email Step) if OTP expired and we are not on step 3
//       }
//       reset({ otp: '' }); // Clear OTP when expired
//     }
//   }, [otpTimeLimit, step]);
...
//       setEmail(data.email); // Update email state here
//       setStep(2); // Move to Step 2 if OTP is sent
//     } catch (error) {
//       console.error("Failed to send OTP:", error);
//       handleApiErrors(error);
//     } finally {
...
//       // Only go to Step 3 if the OTP was valid
//       if (step === 2) {
//         setStep(3);
//       }

//       // Reset form to prepare for next step
//       reset({
//         otp: '', 
//         password: '',
//         confirmPassword: '',
