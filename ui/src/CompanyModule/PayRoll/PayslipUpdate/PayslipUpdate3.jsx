...
const PayslipUpdate3 = () => {
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [fetchPayslipData,employeeId, month, year, authUser.company]);
          ...
          >
            ...
            >
              <div>
                ...
                <p>
                  <b>
                    Name: {payslipData.attendance.firstName}{" "}
                    {payslipData.attendance.lastName}
                  </b>
                </p>
              </div>
              <div>
            ...
            <div className="payslip-details">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style={{ padding: "4px", border: "1px solid black" }}>
                        {payslipData.attendance.totalWorkingDays}
                      </td>
                      <th
                        style={{
                          padding: "4px",
                      ...
                      <td style={{ padding: "4px", border: "1px solid black" }}>
                        {payslipData.attendance.noOfWorkingDays}
                      </td>
                      <th
                        style={{
                          padding: "4px",
              ...
              >
                ...
                >
                  ...
                  <h6>Contact No: {company?.mobileNo}</h6>
                  <h6>Mail Id: {company?.emailId}</h6>
                </div>
              </div>
            </div>
          </div>
