                                ...
                                <table style={{ borderCollapse: "collapse", border: "1px solid black", width: "100%" }}>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style={{ padding: "4px", textAlign: "left", border: "1px solid black" }}></td>
                                            <th style={{ padding: "4px", width: "150px", textAlign: "left", background: "#ffcc80", color: 'black', border: "1px solid black" }}>Locations</th>
                                            <td style={{ padding: "4px", textAlign: "left", border: "1px solid black" }}></td>
                                        </tr>
                                        <tr>
                                ...
                                <table style={{ borderCollapse: "collapse", border: "1px solid black", width: "100%" }}>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style={{ padding: "4px", textAlign: "left", border: "1px solid black" }}>0</td>
...
export default PayslipTemplate3;
