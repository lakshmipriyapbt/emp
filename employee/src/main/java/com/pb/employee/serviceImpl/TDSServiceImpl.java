...
public class TDSServiceImpl implements TDSService {
    ...
    public Collection<TDSResPayload> getCompanyTDS(String companyName, String id, String tdsType)
        ...
        try {
            ...
            throw new EmployeeException(String.format(ErrorMessageHandler.getMessage(EmployeeErrorMessageKey.UNABLE_GET_COMPANY_TDS), e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
