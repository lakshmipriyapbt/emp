...
public class ResourceIdUtils {
    ...
    public static String generateInternshipCertificateResourceId(String id,String timestamp) {
        return generateGlobalResourceId(ResourceType.INTERNSHIP_CERTIFICATE, id, timestamp);
    }
